									...
									<div class="col">
										<div class="header_nav_content d-flex flex-row align-items-center justify-content-start">
											<nav class="main_nav">
												...
												<li class="active"><a href="/gererProfilMedical">Gérer profil medical</a></li>
				...
				<div class="row">
					<div class="col">
						<div class="home_content">
							<div class="home_title">gestion des profiles medicales</div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-8 contact_col">
					<div class="contact_form">
						<div class="contact_title">Liste des profils medicaux</div>
						<div class="contact_form_container">
							<h1> tableau qui cotient tous les profils medicaux</h1>




							<br>
							section pour les informations clients <br>
							section pour les ordonnaces <br>
							section pour BS si c'est le cas<br>
							section pour les certifs<br>
							section pour les visites effectués<br>
							section pour les exams complementaires <br>
							section  (hidden display)pour les antecedent et l'etat civile <br>
