                  ...
                  <div class="row">
                      <div class="col-md-3 col-xs-12 col-sm-6 col-lg-3">
                        <div class="thumbnail text-center photo_view_postion_b" >
                          <img src="http://dkextras.com/DK/images/profile/dfe29f0b7f57ca5cb982ac9b323ac975.jpg" alt=" photo du pateint" class="img">
                        </div>
                      </div>
                      <div class="col-md-9 col-xs-12 col-sm-6 col-lg-9">
                          ...
                          <ul class=" details">
                            ...
                            <li><p><span class="glyphicon glyphicon-earphone one" style="width:50px;"></span>+0000 00000  </p></li>
                            <li><p><span class="glyphicon glyphicon-envelope one" style="width:50px;"></span>m@email.com</p></li>
                            <li><p><span class="glyphicon glyphicon-map-marker one" style="width:50px;"></span>ain km</p></li>
                            <li></li>
                          </ul>
                          </div>
                          <div class="col-md-4">  
                              <p><span class="glyphicon glyphicon-calendar" style="width:50px;"></span>2018/2/15</p>
                               <p><span class="glyphicon glyphicon-user" style="width:50px;"></span>Homme</p>
                              <p><span class="glyphicon glyphicon-credit-card one" style="width:50px;"></span>66330007</p>
                    ...
                    <div class="row"> 
                     <div class="col-md-4">
                        <div class="col-sm-6 col-xs-6 tital " >poids</div><div class="col-sm-6 col-xs-6 contant_i">88</div>
                        <div class="clearfix"></div><div class="bot-border"></div>
                        <div class="col-sm-6 col-xs-6 tital " >longeur</div><div class="col-sm-6 col-xs-6 contant_i">1.88</div>
