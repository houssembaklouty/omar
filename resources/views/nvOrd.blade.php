...
<div class="super_container">
   ...
   <div class="contact">
		...
		<center><h6 style="color:black;">Ajouter  une  nouvelle ordonance</h6></center>
                        
<form method="post" action="{{url('/submitForm')}}">
    {{csrf_field()}}
    <div class="form-group"> 
      <label for="zip_id" class="control-label">Nom Medicament</label>
      <input type="text" class="form-control" id="zip_id" name="NomMedic" placeholder="">
    </div>
    <div class="form-group"> 
      <label for="full_name_id" class="control-label">dosage du medicament</label>
      <input type="text" class="form-control" id="full_name_id" name="dosage" placeholder="">
    </div>

    <div class="form-group"> 
      <label for="street1_id" class="control-label">forme du medicament</label>
      <input type="text" class="form-control" id="street1_id" name="forme" placeholder="">
    </div>

    <div class="form-group">
      <label for="city_id" class="control-label">Quantite de medicament</label>
      <input type="text" class="form-control" id="city_id" name="qte" placeholder="">
    </div>

    <div class="form-group"> 
      <label for="zip_id" class="control-label">nombre de fois par Jour</label>
      <input type="text" class="form-control" id="zip_id" name="nbrFois" placeholder="">
    </div>
    
    <div class="form-group">
      <label for="zip_id" class="control-label">num consultation</label>
      <input type="text" class="form-control" id="zip_id" name="consultation" placeholder="">
    </div>
     <div class="form-group"> <!-- Zip Code-->
      <label for="zip_id" class="control-label">nom patient</label>
      <input type="text" class="form-control" id="zip_id" name="patient" placeholder="">
    </div>
