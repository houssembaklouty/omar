										...
										<div class="header_nav_content d-flex flex-row align-items-center justify-content-start">
											<nav class="main_nav">
												<ul class="d-flex flex-row align-items-center justify-content-start">
                                                    ...
                                                    <li><a href="/">liste des certificats</a></li>
													<li><a href="/">liste des consultations</a></li>
                                                    <li><a href="/">liste des lettres</a></li>
                                                    <li><a href="/">liste des ordonances</a></li>
                                                    <li><a href="/">liste des BS</a></li>
				...
				<div class="col-lg-8 contact_col">
					<div class="contact_form">
						...
						<div class="contact_form_container">
							<h1> tableau qui cotient tous les patients</h1>
							<br>
