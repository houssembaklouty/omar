	...
	<div class="contact">
		<div class="container">
			<div class="row">
				...
				<!-- Contact form -->
						<form method="post" action="{{ route('Consultation.store') }}" novalidate="">
...
<div class="card"  style=" width: 100%; margin: 0 auto;">
  ...
  <div is="content" role="main" class="ui-content">
    <div is="collapsible-set" data-role="collapsibleset">
      <div is="collapsible" data-role="collapsible" data-collapsed-icon="plus" data-collapsed="false">
        <h3>Diagnostic Medical</h3>
        <div is="fieldcontain" class="ui-field-contain">
        <TEXTAREA name="dm" rows=10 cols=100></TEXTAREA>
        </div>
      </div>
    </div>
    <div is="collapsible-set" data-role="collapsibleset">
      <div is="collapsible" data-role="collapsible" data-collapsed-icon="plus" data-collapsed="false">
        <h3>Examen Complementaire</h3>
        <div is="fieldcontain" class="ui-field-contain">
<TEXTAREA name="ec" rows=10 cols=100></TEXTAREA>
        </div>
      </div>
    </div>
    <div is="collapsible-set" data-role="collapsibleset">
      <div is="collapsible" data-role="collapsible" data-collapsed-icon="plus" data-collapsed="false">
        ...
        <div is="fieldcontain" class="ui-field-contain">
          <label for="gk-4165lxd"></label>
<TEXTAREA name="exC" rows=10 cols=100></TEXTAREA>        </div>
      </div>
    </div>
    <div is="collapsible-set" data-role="collapsibleset">
      <div is="collapsible" data-role="collapsible" data-collapsed-icon="plus">
        <h3>motif consultation</h3>
          <TEXTAREA name="mc" rows=10 cols=100></TEXTAREA>
      </div>
    </div>
    <div class="form-group"> 
 		  <label for="street1_id" class="control-label"><h3>tarif</h3></label>
 		  <input type="" class="form-control" id="t" name="t" placeholder="">
 		</div>
<div class="col-md-4 col-sm-6 col-xs-12"style='margin-left:auto;margin-right:auto;display:block;margin-bottom:0%'>
                                           
                                            <select name="p" class="form-control" required>
                                             @foreach($patients as $patient)
                                                <option value="{{$patient->id}}">{{$patient->nom}} {{$patient->nom}}</option>
                                               @endforeach
        ...
        <button style='background: #32c69a;margin-left:auto;margin-right:auto;display:block;margin-bottom:0%'  type="submit" class="btn"><a style="color:white;" >Valider</a></button>
