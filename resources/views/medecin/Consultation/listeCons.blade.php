...
<div class="super_container">
   ...
   <div class="contact">
        <center><h2>Liste des consultations</h2> </center>
		<div class="container">
 ...
 <div class="container" >
        <div class="table-wrapper" class="col-sm-12">
         ...
         <button type="button" class="btn btn-info" onclick="location.href='{{route('Consultation.create')}}'"><a href="{{route('Consultation.create')}}"><i class="fa fa-plus" ></i></a>ajouter nouvelle consultation</button>
  ...
  <tbody>
    ...
    <tr>
     ...
     <td>{{$c->patient->nom}}&nbsp;
{{$c->patient->prenom}}{{$c->patient->id}}</td>
 <td>{{$c->patient->Tel}}</td>   
  <td>{{$c->TarifCons}}</td>
        <td>
        	<a href="">Télecharger</a> &nbsp;&nbsp;
        	<a href="{{route('Consultation.destroy',$c->id)}}">supprimer</a> &nbsp;&nbsp;
        	<a href="{{route('Consultation.nv_ord', $c->patient->id) }}">Nv Ord</a>
        </td>
    </tr>
 @endforeach  
