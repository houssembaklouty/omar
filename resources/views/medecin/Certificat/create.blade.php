...
<div class="super_container">
   ...
   <div class="contact">
		...
		<center><h6 style="color:black;">Ajouter  une  nouvelle certificat</h6></center>
                        
<form method="post" action="{{ route('Certificat.store') }}">
    {{csrf_field()}}
 ...
 <div class="input-group">
 	<h5>type de certif :</h5>
 	    <input name="type" 
 	        type="radio"
 	        id="type_hab"
 	        value="aptitude" 
 	        onclick="handleClick(this)" />
 	    <label for="type_dispense">aptitude</label>
 	    ...
 	    <input name="type" 
 	        ...
 	        value="dispense" 
 	        onclick="handleClick(this)" />
 	    <label for="type_hab">dispense</label>
 	</div>
 	...
 	<div id="dispense">
 		...
 		<div class="form-group"> 
 		  <label for="dateRepos" class="control-label">date Repos</label>
 		  <input type="date" class="form-control" id="dateRepos" name="dateRepos" placeholder="">
 		</div>

 		<div class="form-group">
 		  <label for="NbrJourRepos" class="control-label">NombreJoursRepos</label>
 		  <input type="Number" class="form-control" id="NbrJourRepos" name="NbrJourRepos" placeholder="">
 		</div>
 	</div>
 	<div id="hab">
 		<br>
 		<h4>aptitude : </h4>
 		   <select name="Decision" id="Decision" name="Decision" class="form-control">
        <option selected disabled>Decision</option>
        	<option value="apte"/>inaptitude</option>
			<option value="inapte"/>aptitude</option>
      </select>
 		<div class="form-group"> 
 		  <label for="street1_id" class="control-label">etat de santé</label>
 		  <input type="text" class="form-control" id="street1_id" name="etatSant" placeholder="">
 		</div>
		...
		<center>
		<button  type="submit" class="btn"><a style="color:white;" >Valider</a></button>
</center>
    </div>
...
<script src="../../js/contact.js"></script>
    ...
    <script type="text/javascript">
        ...
        function handleClick(myRadio) {
            ...
            if (myRadio.id == "type_dispense" ) {
                console.log('Done ! habilitation');
                $('#dispense').show();
        		$('#hab').hide();
            }
            else{
