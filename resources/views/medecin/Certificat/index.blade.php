...
<html lang="en">
<head>
<title>liste des certificats</title>
<meta charset="utf-8">
...
<div class="super_container">
   ...
   <div class="contact">
        <center><h2>Liste des certificats</h2> </center>
		<div class="container">
 ...
 <div class="container" >
        <div class="table-wrapper" class="col-sm-12">
         ...
         <button type="button" class="btn btn-info" onclick="location.href='{{route('Certificat.create')}}'"><a href="{{route('Certificat.create')}}"><i class="fa fa-plus" ></i></a>ajouter nouvelle certif</button>
  ...
  <tbody>
    @foreach($certificats as $certificat)
	    <tr>
	    	...
	    	<td>{{$certificat->created_at}}</td>
	    	
	    	<td>{{$certificat->patient->nom}} {{$certificat->patient->prenom}}</td>
	    	<td>
	    		@if(($certificat->type)=='aptitude')
	    			{{$certificat->type}} / {{$certificat->aptitude->first()->decision}}
	    		@else
	    			{{$certificat->type}}
	    		@endif
