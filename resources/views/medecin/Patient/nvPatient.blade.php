			...
			@include('layouts.messages')
				...
				<div class="col-lg-12 info_box_col">
					<div class="info_form_container" align="center">
						<div class="info_form_title">Ajouter Patient</div>
						<br>
<form method="post" action="{{ route('Patient.store') }}" novalidate="">
        @csrf {{csrf_field()}}  
  <div class="form-row">
    <div class="form-group col-md-12">
      
      <input type="text" name="nom" class="form-control" id="nom" value="{{ old('nom') }}" placeholder="nom du patient" >
    </div>
    <div class="form-group col-md-12">
      
      <input type="text" class="form-control" name="prenom" value="{{ old('prenom') }}" placeholder="prenom" required>
    </div>
  </div>
  <div class="form-group">
   
    <input name="adresse" type="text" class="form-control" value="{{ old('adresse') }}" placeholder="Adresse" required>
  </div>
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="pro"value="{{ old('pro') }}" placeholder="Profession">
  </div>
  <div class="form-group">
   
    <input type="Date" class="form-control" value="{{ old('dateNais') }}" name="dateNais" placeholder="Age">
  </div>


<div class="form-group">
   
    <input type="number" class="form-control" value="{{ old('cin') }}" name="cin" placeholder="CIN">
  </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-12">
      ...
      <input type="text" name="ville" class="form-control"value="{{ old('vile') }}" id="inputCity"placeholder="ville">
    </div>
    <div class="form-group col-md-12">
    ...
    <div class="form-group col-md-12">
      ...
      <input name="Tel" type="text" class="form-control" id="inputZip" value="{{ old('Tel') }}"placeholder="Tel">
    </div>
  </div>
