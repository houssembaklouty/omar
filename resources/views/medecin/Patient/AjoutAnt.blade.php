...
<div class="super_container">
   ...
   <div class="contact">
		...
		<center><h6 style="color:black;">Ajouter un antecedent</h6></center>
...
<form method="post" action="{{route('antecedents.store')}}">
    {{csrf_field()}}
     ...
     <div class="form-group">
	  ...
	  <select class="form-control" name="patient_id">
	  	  <option selected disabled>liste des patients </option>
    ...
    <div class="form-group" >
     <select name="ant" id="ant" class="form-control">
                <option selected disabled>categorie antecedent </option>
        	    <option value="Medicaux"/>Medicaux</option>
			    <option value="Chirugicaux"/>Chirugicaux </option>
				<option value="Familiaux"/>Familiaux </option>
				<option value="Allergies"/>Allergies </option>
				<option value="IntolerancesMédicamenteuses"/>Intolerances Médicamenteuses</option>
                <option value="Autress"/>Autres</option>
     </select>
    </div>
   ...
   <div is="collapsible-set" data-role="collapsibleset">
      <div is="collapsible" data-role="collapsible" data-collapsed-icon="plus" data-collapsed="false">
        <h3 style='margin-left: 180px;'>description antecedent</h3>
        <div is="fieldcontain" class="ui-field-contain">
<TEXTAREA style='margin-left: 180px;'name="descAnt" rows=10 cols=144></TEXTAREA>
        </div>
      </div>
    </div> 
		<div class="form-group"> 
