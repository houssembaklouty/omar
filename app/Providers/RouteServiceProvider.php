...
class RouteServiceProvider extends ServiceProvider
{
    ...
    /**
     * Define the "secretaire" routes for the application.
     *
     * These routes are typically stateless.
     *
     * @return void
     */
    protected function mapSecretaireRoutes()
    {
        Route::prefix('secretaire')
             ->middleware('web')
             ->namespace($this->namespace)
             ->group(base_path('routes/secretaire.php'));
    }
